#=====================================================================================
# DESCRIPTION : file fetches, parses, and caches official FDA drug label information 
#               to enrich adverse event analysis with authoritative medical context
#=====================================================================================
...
#====================================================================================
# It initializes a local SQLite cache database for storing FDA drug label information
#====================================================================================
...
#======================================================================================
# It checks whether FDA drug information for a given drug is already cached in the local 
# SQLite database and returns it if found
#======================================================================================
...
#============================================================================================
# It saves parsed FDA drug information into the local SQLite cache for future quick retrieval
#============================================================================================
...
#================================================================================================
# It cleans and normalizes text extracted from FDA labels, removing artifacts and limiting length
#================================================================================================
...
#======================================================================
# It parses the SPL XML from DailyMed to extract key sections like
# Indications, Warnings, and Adverse Reactions
#======================================================================
...
#==================================================================================================
# It fetches drug information from the DailyMed API, first searching for the drug to get its setid,
# then fetching the SPL XML, and finally parsing it to extract relevant sections
#==================================================================================================
...
def get_drug_info(drug_name: str) -> Dict:
    ...
    print(f" Could not fetch drug info for: {drug_name}")
    return {
        "source": "FDA DailyMed",
        "indications": "Information not available",
        "warnings": "Information not available",
