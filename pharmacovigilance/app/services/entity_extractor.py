#===================================================================================
# DESCRIPTION : This is an entity extraction module that tries to extract drug names
 # and adverse event symptoms using an LLM (Qwen 2.5 via Ollama) and 
 # falls back to rule-based extraction if the LLM is unavailable or unreliable.
#====================================================================================
...
"""
import re       # used to extract JSON from messy LLM output
